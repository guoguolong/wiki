今天，有个后辈问我Ext4的优点，一下子不知道该怎么说，以前只知道Ext4启动快点，对文件恢复和碎片整理好一点。但具体怎样，怎没研究过。就顺手谷哥下。查到以下资料，谨供大家参考。
...
IOzone 测试命令为： time /opt/iozone/bin/iozone -a -s 4G -q 256 -y 4 >|/root/ext4-iozone-stdout.txt
